...
class CircularProgressView: UIView {
    ...
    var color: UIColor = UIColor(named: "Blue") ?? UIColor.blue
    /// Circle backgroundColor
    let Backgroundcolor: UIColor = UIColor(named: "White") ?? UIColor.white
    ///0.0 - 1.0
    ...
    private func createLabels(){
        ...
        let firstAttributes: [NSAttributedString.Key: Any] = [ .font: UIFont.systemFont(ofSize: 25.0), .foregroundColor: self.color, .paragraphStyle: titleParagraphStyle]
